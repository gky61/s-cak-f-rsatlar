...
Bu klasör, FırsatKolik platformunun reaktif veritabanı trigger'larını, zamanlanmış bakım cron görevlerini ve güvenli API proxy'lerini barındıran **26 adet Cloud Function**'ı içerir (`index.js`).
