...
class PazaramaScraper extends BaseProductScraper {
  ...
  double? scrapeRatingValue(dom.Document document) {
    print('[aggregateRating] PazaramaScraper: ratingValue aranıyor...');
    final productJson = findProductJsonLd(document);
    if (productJson != null) {
      ...
      if (rating?['ratingValue'] != null) {
        ...
        print('[aggregateRating] PazaramaScraper: JSON-LD ile ratingValue bulundu: $val');
        return val;
      }
    }
    ...
    for (final script in scripts) {
      ...
      if (text.contains('aggregateRating') || text.contains('ratingValue')) {
        ...
        if (match != null) {
          ...
          if (parsed != null) {
            print('[aggregateRating] PazaramaScraper: Regex fallback ile ratingValue bulundu: $parsed');
            return parsed;
          }
        }
      }
    ...
    print('[aggregateRating] PazaramaScraper: ratingValue bulunamadı (null)');
    return null;
  }

  @override
  int? scrapeRatingCount(dom.Document document) {
    print('[aggregateRating] PazaramaScraper: ratingCount/reviewCount aranıyor...');
    final productJson = findProductJsonLd(document);
    if (productJson != null) {
      final rating = extractRatingFromProductJson(productJson);
      if (rating?['ratingCount'] != null) {
        final cnt = (rating!['ratingCount'] as num).toInt();
        print('[aggregateRating] PazaramaScraper: JSON-LD ile ratingCount/reviewCount bulundu: $cnt');
        return cnt;
      }
    }
    ...
    for (final script in scripts) {
      ...
      if (text.contains('aggregateRating') || text.contains('reviewCount')) {
        ...
        if (match != null) {
          ...
          if (parsed != null) {
            print('[aggregateRating] PazaramaScraper: Regex fallback ile ratingCount/reviewCount bulundu: $parsed');
            return parsed;
          }
        }
      }
    ...
    print('[aggregateRating] PazaramaScraper: ratingCount bulunamadı (null)');
    return null;
  }

  @override
  String? scrapeBrand(dom.Document document) {
    print('[aggregateRating] PazaramaScraper: brand (marka) aranıyor...');
    final productJson = findProductJsonLd(document);
    if (productJson != null) {
      final brand = extractBrandFromProductJson(productJson);
      if (brand != null && brand.isNotEmpty) {
        print('[aggregateRating] PazaramaScraper: JSON-LD ile brand bulundu: $brand');
        return brand;
      }
    }
      ...
      if (text.contains('"brand"') || text.contains('"Brand"')) {
        ...
        if (match != null) {
          ...
          if (bName != null && bName.isNotEmpty && !bName.contains('{')) {
            print('[aggregateRating] PazaramaScraper: Regex fallback ile brand bulundu: $bName');
            return bName;
          }
        }
      }
    ...
    print('[aggregateRating] PazaramaScraper: brand bulunamadı (null)');
    return null;
  }
