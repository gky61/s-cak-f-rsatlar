...
class DefactoScraper extends BaseProductScraper {
  ...
  double? scrapeRatingValue(dom.Document document) {
    print('[aggregateRating] DefactoScraper: ratingValue aranıyor...');
    ...
    if (productJson != null) {
      ...
      if (rating?['ratingValue'] != null) {
        ...
        print('[aggregateRating] DefactoScraper: JSON-LD ile ratingValue bulundu: $val');
        return val;
      }
    }
    ...
    if (ratingEl != null) {
      ...
      if (parsed != null && parsed > 0 && parsed <= 5.0) {
        print('[aggregateRating] DefactoScraper: DOM fallback ile ratingValue bulundu: $parsed');
        return parsed;
      }
    }
    ...
    for (final script in scripts) {
      ...
      if (text.contains('aggregateRating') || text.contains('ratingValue')) {
        ...
        if (match != null) {
          ...
          if (parsed != null && parsed > 0 && parsed <= 5.0) {
            print('[aggregateRating] DefactoScraper: Regex fallback ile ratingValue bulundu: $parsed');
            return parsed;
          }
        }
      }
    ...
    print('[aggregateRating] DefactoScraper: ratingValue bulunamadı (null)');
    return null;
  }

  @override
  int? scrapeRatingCount(dom.Document document) {
    print('[aggregateRating] DefactoScraper: ratingCount/reviewCount aranıyor...');
    ...
    if (productJson != null) {
      ...
      if (rating?['ratingCount'] != null) {
        ...
        print('[aggregateRating] DefactoScraper: JSON-LD ile ratingCount/reviewCount bulundu: $cnt');
        return cnt;
      }
    }
    ...
    if (countEl != null) {
      ...
      if (match != null) {
        ...
        if (parsed != null && parsed > 0) {
          print('[aggregateRating] DefactoScraper: DOM fallback ile ratingCount bulundu: $parsed');
          return parsed;
        }
      }
    }
    ...
    for (final script in scripts) {
      ...
      if (text.contains('aggregateRating') || text.contains('reviewCount') || text.contains('ratingCount')) {
        ...
        if (match != null) {
          final parsed = int.tryParse(match.group(1) ?? '');
          if (parsed != null && parsed > 0) {
            print('[aggregateRating] DefactoScraper: Regex fallback ile ratingCount bulundu: $parsed');
            return parsed;
          }
        }
      }
    ...
    print('[aggregateRating] DefactoScraper: ratingCount bulunamadı (null)');
    return null;
  }

  @override
  String? scrapeBrand(dom.Document document) {
    print('[aggregateRating] DefactoScraper: brand (marka) aranıyor...');
    ...
    if (productJson != null) {
      ...
      if (brand != null && brand.isNotEmpty) {
        print('[aggregateRating] DefactoScraper: JSON-LD ile brand bulundu: $brand');
        return brand;
      }
    }
    ...
    if (brandMeta != null) {
      ...
      if (clean.isNotEmpty) {
        print('[aggregateRating] DefactoScraper: DOM fallback ile brand bulundu: $clean');
        return clean;
      }
    }
      ...
      if (text.contains('"brand"') || text.contains('"Brand"')) {
        ...
        if (match != null) {
          ...
          if (bName != null && bName.isNotEmpty && !bName.contains('{')) {
            print('[aggregateRating] DefactoScraper: Regex fallback ile brand bulundu: $bName');
            return bName;
          }
        }
      }
    ...
    print('[aggregateRating] DefactoScraper: brand bulunamadı (null)');
    return null;
  }
}
