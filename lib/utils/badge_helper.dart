...
class BadgeHelper {
  ...
  static const Map<String, BadgeInfo> badges = {
    ...
    'hunter_apprentice': BadgeInfo(
      ...
      howToEarn: 'Toplam 5 adet fırsat paylaşımına ulaşın.',
    ),
    'contributor': BadgeInfo(
      ...
      howToEarn: 'Toplam 10 adet fırsat paylaşın.',
    ),
    'master_hunter': BadgeInfo(
      ...
      howToEarn: 'Toplam 25 adet fırsat paylaşımına ulaşın.',
    ),
    'legendary_hunter': BadgeInfo(
      ...
      howToEarn: 'Toplam 100 adet fırsat paylaşımına ulaşın.',
    ),
    ...
    'active_voter': BadgeInfo(
      ...
      howToEarn: 'Fırsatları oylayarak en az 30 puana ulaşın.',
    ),
    'flame_master': BadgeInfo(
      ...
      howToEarn: 'Toplam 100 puan veya +100°C fırsat etkileşimine ulaşın.',
    ),
    'volcanic_record': BadgeInfo(
      ...
      howToEarn: 'Toplam 300 puan veya rekor sıcaklık seviyesine ulaşın.',
    ),
    ...
    'voice_of_community': BadgeInfo(
      ...
      howToEarn: 'Yorumlar ve değerlendirmelerle toplulukta aktif olun.',
    ),
    'helpful': BadgeInfo(
      id: 'helpful',
      ...
      howToEarn: 'Yorumlarınızda veya paylaşımlarınızda 25 beğeni toplayın.',
    ),
    'top_reviewer': BadgeInfo(
      ...
      howToEarn: 'Toplamda 100 beğeniye veya yüksek yorum etkileşimine ulaşın.',
    ),
    ...
    'gold': BadgeInfo(
      ...
      howToEarn: 'Toplam 200 puana ulaşın.',
    ),
    'silver': BadgeInfo(
      id: 'silver',
      name: 'Gümüş Avcı',
      ...
      howToEarn: 'Toplam 60 puana ulaşın.',
    ),
    'bronze': BadgeInfo(
      id: 'bronze',
      name: 'Bronz Avcı',
      ...
      howToEarn: 'Toplam 10 puana ulaşın.',
    ),
  };
