...
/// Trendyol "Plus'a Özel" fırsat rozeti (Mor-Turuncu Minimalist Tasarım)
class TrendyolPlusBadge extends StatelessWidget {
  final bool compact;
  ...
  /// Yardımcı metot: Fırsat bir Trendyol Plus fırsatı mı?
  static bool isTrendyolPlusDeal(dynamic deal) {
    if (deal == null) return false;
    final store = (deal.store ?? '').toString().toLowerCase();
    if (!store.contains('trendyol') && !store.contains('ty')) return false;
