...
class AktuelMagazalarPage extends StatelessWidget {
  ...
  static const List<Magaza> _magazalar = [
    ...
    Magaza(code: 'cagri', name: 'Çağrı', logoAsset: 'assets/cagri.jpg', brandColor: Color(0xFFE31B23)),
    Magaza(code: 'happycenter', name: 'HappyCenter', logoAsset: 'assets/happycenter.jpg', brandColor: Color(0xFF8DC63F)),
